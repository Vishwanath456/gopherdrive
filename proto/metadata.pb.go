...
func (x *RegisterRequest) GetFilepath() string {
	if x != nil {
		return x.Filepath
	}
	return ""
...
func (x *UpdateRequest) GetSha256() string {
	if x != nil {
		return x.Sha256
	}
	return ""
...
func (x *UpdateRequest) GetExtension() string {
	if x != nil {
		return x.Extension
	}
	return ""
...
func (x *GetResponse) GetFilepath() string {
	if x != nil {
		return x.Filepath
	}
	return ""
...
const file_proto_metadata_proto_rawDesc = "" +
	"\n" +
	"\x14proto/metadata.proto\x12\x05proto\"Y\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\bfilepath\x18\x02 \x01(\tR\bfilepath\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status2\xc1\x01\n" +
